...
namespace IIS.Proba2
{
    ...
    [View("ПланирСобесE", new string[] {
            ...
            "РегистАнкеты.ВакантДолжн.Должность as \'Вакантная должность\'"}, Hidden=new string[] {
    ...
    public class ПланирСобес : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proba2.РегистАнкеты fРегистАнкеты;
        ...
        [PropertyStorage(new string[] {
                "РегистАнкеты"})]
        [NotNull()]
        public virtual IIS.Proba2.РегистАнкеты РегистАнкеты
        {
            get
            {
                ...
                IIS.Proba2.РегистАнкеты result = this.fРегистАнкеты;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланирСобесE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесE", typeof(IIS.Proba2.ПланирСобес));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланирСобесL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланирСобесL", typeof(IIS.Proba2.ПланирСобес));
                }
            }
        }
    }
